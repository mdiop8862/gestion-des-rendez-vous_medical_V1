	      ...
	      <nav class="navbar navbar-expand-lg  bg-success" >
	      	...
	      	<ul class="navbar-nav  ">
	      		<li class="nav-item"><a href="listervjm.php" class="nav-link text-light text-uppercase px-3">Acceuil</a>  </li> 
	      		 ...
	      		 <li class="nav-item text-uppercase px-3"><a href="rv.php" class="nav-link text-light">Medecin</a>

	      		</li>

           
	    <li class="nav-item text-uppercase px-3 dropdown "> <a href="#" class="nav-link text-light "  >Patient</a>
	      			>
           
	      		</li>
	      		 <li class="nav-item text-uppercase px-3 dropdown "> <a href="#" class="nav-link text-light "  >Secretaire</a>
